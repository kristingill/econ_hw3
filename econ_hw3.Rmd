...
numb5_results <- numb5_df %>% 
  filter(scc %in% c("51", "60", "70", "80", "90", "100", "110", "120", "130", "140", "150")) %>% 
...
kbl(numb5_results, caption = "Table 1: Results for different estimates of the social cost of carbon. All values, aside from percents and gallons, are in dollars.") %>% 
